...
function ChemistryDetailedSyllabusClass12() {
  return (
    <>
      <Navbar />
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold mb-4">
          Detailed Chemistry Syllabus for Class 12
        </h2>
          ...
          <tbody>
            <tr>
              <td className="px-4 py-2 border border-gray-300">
                ...
                inside and outside). Electric potential, potential difference,
                electric potential due to a point charge, a dipole and system of
                charges: equipotential surfaces, electrical potential energy of
                a system of two point charges and of electric dipoles in an
                ...
                plate capacitor with and without dielectric medium between the
              ...
              <td className="px-4 py-2 border border-gray-300">
                ...
                characteristics (linear and nonlinear), electrical energy and
                power, electrical resistivity and conductivity. Carbon
                ...
                cell, combination of cells in series and in parallel. Kirchoff’s
            ...
            <tr>
              <td className="px-4 py-2 border border-gray-300">
                ...
                and its application to current-carrying circular loop. Ampere’s
                law and its applications to infinitely long straight wire,
                ...
                ampere. Torque experienced by a current loop in a magnetic
                ...
                a revolving electron. Magnetic Field Intensity due to a magnetic
                dipole(bar magnet) along its axis and perpendicular to its axis.
                Torque on a magnetic dipole (bar magnet) in a uniform magnetic
                field; bar magnet as an equivalent solenoid, magnetic field
                lines; Earth’s magnetic field; bar magnet as an equivalent
                solenoid, magnetic field lines; Earth’s magnetic field and
                magnetic elements. Para -, dia-and ferro-magnetic substances,
                with examples. Electromagnetic and factors affecting their
              ...
              <td className="px-4 py-2 border border-gray-300">
                ...
                power in AC circuits, wattles current. AC generator and
                transformer.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="px-4 py-2 border border-gray-300">
                ...
                combination of a lens and a mirror. Refraction and dispersion of
                light through a prism Scattering of light – blue colour of the
                sky and reddish appearance of the sun at sunrise and sunset.
                Optical instruments: Human eye, image formation and
                accommodation, correction of eye defects (myopia and hyper
                myopia) using lenses. Microscopes and astronomical telescopes
                (reflecting and refracting) and their magnifying powers. Wave
                optics: Wavefront and Huygens principle, reflection and
                refraction of plane waves at a plane surface using wavefronts.
                Proof of laws of reflection and refraction using Huygens
                principle. Interference, Young’s double hole experiment and
                expression for fringe width, coherent sources and sustained
                interference of light. Diffraction due to a single slit, width
                of central maximum. Resolving power of microscopes and
            ...
            <tr>
              ...
              <td className="px-4 py-2 border border-gray-300">
                Alpha – particle scattering experiments; Rutherford’s model of
                atom; Bohr model, energy levels, hydrogen spectrum. Composition
                and size of nucleus, atomic masses, isotopes, isobars; isotones
                Radioactivity – alpha, beta and gamma particles/rays and their
                properties, decay law. Mass-energy relation, mass defect;
            ...
            <tr>
              <td className="px-4 py-2 border border-gray-300">
                ...
                oscillator. Logic gates (OR, AND, NOT, NAND and NOR). Transistor
                as a switch.
              </td>
            </tr>
          </tbody>
...
export default ChemistryDetailedSyllabusClass12